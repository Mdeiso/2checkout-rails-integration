...
In this tutorial we will walk through integrating the 2Checkout payment method into an existing Rails 3.2.2 shopping cart application using the [twocheckout gem](https://rubygems.org/gems/twocheckout). The source for the example shopping cart application used in this tutorial can be accessed in this [Github repository](https://github.com/craigchristenson/2checkout-rails-integration/ "2checkout-rails-integration").

Setting up the Example Application
----------------------------------

We need an existing example application to demonstrate the integration so lets clone the 2checkout-rails-integration application.

```shell
$ git clone https://github.com/craigchristenson/2checkout-rails-integration
```
...
```shell
$ cd 2checkout-rails-integration/2checkout-rails-example-before
```
...
![](http://github.com/craigchristenson/2checkout-rails-integration/raw/master/img/1.png)
...
![](http://github.com/craigchristenson/2checkout-rails-integration/raw/master/img/2.png)

We can test the current shopping cart functionality of the application by adding a couple of products to the cart.

![](http://github.com/craigchristenson/2checkout-rails-integration/raw/master/img/3.png)
...
![](http://github.com/craigchristenson/2checkout-rails-integration/raw/master/img/4.png)
...
![](http://github.com/craigchristenson/2checkout-rails-integration/raw/master/img/5.png)
...
![](http://github.com/craigchristenson/2checkout-rails-integration/raw/master/img/6.png)
...
![](http://github.com/craigchristenson/2checkout-rails-integration/raw/master/img/7.png)
...
![](http://github.com/craigchristenson/2checkout-rails-integration/raw/master/img/8.png)
